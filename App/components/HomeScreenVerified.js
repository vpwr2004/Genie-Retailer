        ...
        {/* <Text className="text-[14px] text-center mb-[20px]">Your ongoing requests</Text> */}
...

            {
                ...
                ongoingRequests?.map((product)=>(
                  ...
                  <TouchableOpacity key={product._id} onPress={()=>{dispatch(setRequestInfo(product)); console.log("requestInfo at homeScreen",product);navigation.navigate("requestPage")}}>
